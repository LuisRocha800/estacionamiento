...
public class invitadoSalidaSession extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private String opcnUsr;
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		salida.print("<!DOCTYPE html>\r\n"
				...
				+ "	\r\n"
				+ "	<form action=\"salidainvitado\">\r\n"
				+ "		<div class=\"ext1\"> </div>\r\n"
				+ "		<label1> IMPORTANTE</label1> <br>\r\n"
				+ "		<div class=\"ext2\"> </div>\r\n"
				+ "		<label2> Registrara su salida. <b>Prepare la Identificacion que se le entrego cuando ingreso</b></label2>\r\n"
				+ "		<div class=\"ext2\"> </div>\r\n"
				+ "		<label3> Los pasos a seguir son los siguientes:</label3>\r\n"
				+ "		<div class=\"ext2\"> </div>\r\n"
				+ "		<label4> 1) Pulse aceptar <br>\r\n"
				+ "		         2) Acerque su Identificacion al sensor RIFD (NFC) <br>\r\n"
				+ "		</label4>\r\n"
				+ "		<div class=\"ext3\"> </div>\r\n"
				+ "		<input class=\"btnAceptar\" type=\"submit\" value=\"Aceptar\">\r\n"
				+ "     <input type=\"hidden\" name=\"operacion\" value="+opcnUsr+">"
				+ "	</form>\r\n"
				+ "</div>\r\n"
