...
public class operationPensionado extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		salida.print("<!DOCTYPE html>\r\n"
				...
				+ "	\r\n"
				+ "	<form action=\"salidaentradapensionado\">\r\n"
				+ "		<div class=\"ext1\"> </div>\r\n"
				+ "		<label1> IMPORTANTE</label1> <br>\r\n"
				+ "		<div class=\"ext2\"> </div>\r\n"
				+ "		<label2> Registrara su entrada como pensionado. <b>Prepare su tarjeta de acceso</b></label2>\r\n"
				+ "		<div class=\"ext2\"> </div>\r\n"
