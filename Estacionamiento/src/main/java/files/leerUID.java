...
public class leerUID extends HttpServlet {
        ...
        if(opcnUsr.equals("ingreso")) {
        	 ...
        	 try {
        		...
        		nfc_movementsDaoDerbyImp nfc = new nfc_movementsDaoDerbyImp();
 	            PersonalDAODerbyImp personalGet = new PersonalDAODerbyImp();
 	            personalGet.setConexion(conexion);	
 				
 				nfc_movements mvmt = new nfc_movements();
 				Personal pers = new Personal();
 				pers.setId_tag(dataToValidate);
 			    Personal pr = personalGet.get(pers);
 				String tagid = pr.getId_tag();
